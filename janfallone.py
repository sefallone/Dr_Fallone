...
if menu == "Dashboard Actual":
    ...
    with st.expander("📋 Ingresar Facturación por Especialidad"):
        ...
        with c1:
            ccee_OSB_1 = st.number_input("Médico 1 (CCEE)", key="ccee_osb_1", min_value=0.0, step=5000.0)
        with c2:
            ccee_OSB_2 = st.number_input("Médico 2 (CCEE)", key="ccee_osb_2", min_value=0.0, step=5000.0)
        with c3:
            ccee_OSB_3 = st.number_input("Médico 3 (CCEE)", key="ccee_osb_3", min_value=0.0, step=5000.0)
        with c4:
        ...
        with s1:
            ccee_SMOB_1 = st.number_input("Médico 1 (CCEE)", key="ccee_smob_1", min_value=0.0, step=5000.0)
        with s2:
            ccee_SMOB_2 = st.number_input("Médico 2 (CCEE)", key="ccee_smob_2", min_value=0.0, step=5000.0)
        with s3:
            ccee_SMOB_3 = st.number_input("Médico 3 (CCEE)", key="ccee_smob_3", min_value=0.0, step=5000.0)
        with s4:
            ccee_SMOB_4 = st.number_input("Médico 4 (CCEE)", key="ccee_smob_4", min_value=0.0, step=5000.0)
        with s5:
        ...
        with j1:
            ccee_JPP_1 = st.number_input("Médico 1 (CCEE)", key="ccee_jpp_1", min_value=0.0, step=5000.0)
        with j2:
            ccee_JPP_2 = st.number_input("Médico 2 (CCEE)", key="ccee_jpp_2", min_value=0.0, step=5000.0)
        with j3:
        ...
        with q1:
            q_OSB_1 = st.number_input("Médico 1 (Q)", key="q_osb_1", min_value=0.0, step=15000.0)
        with q2:
            q_OSB_2 = st.number_input("Médico 2 (Q)", key="q_osb_2", min_value=0.0, step=15000.0)
        with q3:
            q_OSB_3 = st.number_input("Médico 3 (Q)", key="q_osb_3", min_value=0.0, step=15000.0)
        with q4:
        ...
        with q5:
            q_SMOB_1 = st.number_input("Médico 1 (Q)", key="q_smob_1", min_value=0.0, step=15000.0)
        with q6:
            q_SMOB_2 = st.number_input("Médico 2 (Q)", key="q_smob_2", min_value=0.0, step=15000.0)
        with q7:
            q_SMOB_3 = st.number_input("Médico 3 (Q)", key="q_smob_3", min_value=0.0, step=15000.0)
        with q8:
        ...
        with q10:
            q_JPP_1 = st.number_input("Médico 1 (Q)", key="q_jpp_1", min_value=0.0, step=15000.0)
        with q11:
            q_JPP_2 = st.number_input("Médico 2 (Q)", key="q_jpp_2", min_value=0.0, step=15000.0)
        with q12:
        ...
        with u1:
            u_OSB_1 = st.number_input("Médico 1 (U)", key="u_osb_1", min_value=0.0, step=10000.0)
        with u2:
            u_OSB_2 = st.number_input("Médico 2 (U)", key="u_osb_2", min_value=0.0, step=10000.0)
        with u3:
            u_OSB_3 = st.number_input("Médico 3 (U)", key="u_osb_3", min_value=0.0, step=10000.0)
        with u4:
        ...
        with u5:
            u_SMOB_1 = st.number_input("Médico 1 (U)", key="u_smob_1", min_value=0.0, step=10000.0)
        with u6:
            u_SMOB_2 = st.number_input("Médico 2 (U)", key="u_smob_2", min_value=0.0, step=10000.0)
        with u7:
            u_SMOB_3 = st.number_input("Médico 3 (U)", key="u_smob_3", min_value=0.0, step=10000.0)
        with u8:
            u_SMOB_4 = st.number_input("Médico 4 (U)", key="u_smob_4", min_value=0.0, step=10000.0)
        with u9:
        ...
        with u10:
            u_JPP_1 = st.number_input("Médico 1 (U)", key="u_jpp_1", min_value=0.0, step=10000.0)
        with u11:
            u_JPP_2 = st.number_input("Médico 2 (U)", key="u_jpp_2", min_value=0.0, step=10000.0)
        with u12:
